...
import { Mail, Lock, Eye, EyeOff, Loader2, ArrowLeft, LogIn, AlertCircle, CheckCircle2 } from 'lucide-react';
import { loginUser } from '../api.js';

export default function Login({ onToggleRegister, onBackHome, onSuccess }) {
